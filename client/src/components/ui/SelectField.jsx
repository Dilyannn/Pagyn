      ...
      <div className="relative group">
        <div
          ...
          className={`
            ...
            text-gray-900 placeholder:text-gray-400 min-h-[52px]
        ...
        >
          ...
          <div className={`absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 transition-transform duration-200 ${isOpen ? "rotate-180 text-violet-500" : ""}`}>
